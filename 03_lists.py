...
print(my_list.index("4th"))  # returns index of the specified element; could raise a ValueError (element not in list)
...
print(list_triple)  # multiplies the list, concatenating it N times

# we can use list(str) to transform a string into a list, and also the other way,
# using list_var.join('') to concatenate elements in a list joining them together
_str = 'palindrome'
print(f'Initial string: \'{_str}\'')
print(f'String as list: {list(_str)}')
print(f'List again as string: {"".join(list(_str))}')

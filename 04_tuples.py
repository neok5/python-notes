...
# unlike lists, tuples are immutable, you can't add or remove elements
# my_tuple.append("extra_element") # this would be wrong

print(1992 in my_tuple)  # return if the element is in the tuple

print(my_tuple.index(1992))  # returns the index of the specified element; could raise a ValueError

...
class Car:
    ...
    def __init__(self, ident, longitude, width, size_unit):
        self.ident = ident
    ...
    def __del__(self):
        print(f'The object {self.ident} was removed')

    def __str__(self):
        return f'{self.ident} - Car size is {self.longitude}x{self.width} {self.__size_unit} and is {self.__status}'
